                        ...
                        <div class="container">
                            <div class="row">
                              ...
                              if(isset($_GET['ref'])){
                                  ...
                                  $sql = "SELECT * FROM resell WHERE category=$category AND status = 1";
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            <?php
                                                if(!empty($cover)){
                                                    ?>
                                            <a href="details-view.php?resell=<?php echo $resell_id; ?>" target="_blank"
                                                rel="noopener noreferrer"><img class="img-fluid" height="50px"
                                                    width="100px" src="img/resell/<?php echo $cover; ?>"></a>
                                            <?php
                                                }  
                                                else{
                                                    ?>
                                        ...
                                        <div class="card-body">
                                            <a href="details-view.php?resell=<?php echo $resell_id; ?>">
            ...
            <div class="container">
                <div class="row">
                    <?php
                                    ...
                                    $sql = "SELECT * FROM resell WHERE reseller_area=$area_id AND status=1";
                                    $searchByArea = mysqli_query($conn, $sql);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * FROM resell WHERE status = 1 ORDER BY ID DESC LIMIT 9";
