                        ...
                        <div class="container">
                            <div class="row">
                              ...
                              if(isset($_GET['ref'])){
                                  ...
                                  $sql = "SELECT * FROM accessories WHERE category=$category AND status = 1";
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                            ...
                                            <a href="details-view.php?access=<?php echo $id; ?>" target="_blank"
                                                rel="noopener noreferrer"><img class="img-fluid" height="50px"
                                                    width="100px" src="img/accessories/<?php echo $cover; ?>"></a>
                                            <?php
                                                }  
                                                else{
                                                    ?>
                                        ...
                                        <div class="card-body">
                                            <a href="details-view.php?access=<?php echo $id; ?>">
                                                <h6 class="card-title text-center"><?php echo $access_name; ?></h6>
                                            </a>
                                            <h6 class="text-center"> অনুদান করেছেন<span
                                                    class="card-text"><?php echo $donor_name; ?></span></h6>
                ...
                <div class="row">
                    <?php
                            ...
                            $area_id = $_POST['area'];
                                    ...
                                    $sql = "SELECT * FROM accessories WHERE donor_area=$area_id AND status = 1";
                                    $searchByArea = mysqli_query($conn, $sql);

                        while($row = mysqli_fetch_assoc($searchByArea) ){
                            $id           = $row['ID'];
                            $access_name    = $row['access_title'];
                            $donor_name     = $row['donor_Name'];                                     $area         = $row['donor_area'];
                            $price        = $row['price'];
                            $cover        = $row['accessories_pic'];
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * FROM accessories WHERE status = 1 ORDER BY ID DESC LIMIT 9";
