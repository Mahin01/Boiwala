                        ...
                        <div class="container">
                            <div class="row">
                              ...
                              if(isset($_GET['ref'])){
                                  ...
                                  $sql = "SELECT * FROM book_exchange WHERE category=$category AND status=1";
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card shadow mb-4">
                                        <div class="card-header py-3">
                                          ...
                                          if(!empty($cover)){
                                              ?>
                                            <a href="details-view.php?Exchange=<?php echo $exchange_id; ?>"
                                      ...
                                      ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h6 class="text-center"><span class="card-text">Exchange Only!</span></h6>
                                        </div>
                                    </div>
                                </div>
                                <?php
                ...
                <div class="row">
                    <?php
                            ...
                            $area_id = $_POST['area'];
                                    ...
                                    $sql = "SELECT * FROM book_exchange WHERE exchanger_area=$area_id AND status=1";
                                    $searchByArea = mysqli_query($conn, $sql);
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <?php
                                            if(!empty($cover)){
                                                ?>
                                <a href="details-view.php?Exchange=<?php echo $exchange_id; ?>" target="_blank"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * FROM book_exchange WHERE status=1 ORDER BY ID DESC LIMIT 9";
                    ...
                    <div class="col-md-4">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="text-center"><span class="card-text"><?php echo $author_name; ?></span></h6>
                                <h6 class="text-center"><i class="fas fa-exchange-alt"></i><span
